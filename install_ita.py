...
TRANSLATIONS = {
    ...
    'Настройте позже': 'Configura после',
    ...
    'Регулировка температуры камеры...': 'Regolazione температура camera...',
    ...
    'Устройство подачи филамента не работает.': 'Alimentatore filamento non работает.',
    ...
    'Регулировка координат при креплении /отсоединении печатающей головки': 'Regolazione cambio testina',
    ...
    'Подтвердить выход? Калибровочные координаты не будут сохранены.': 'Confermare uscita? Le coordinate di calibrazione non будут сохранены.',
    '«Калибровка ручного выравнивания» сейчас\nзапустится, это займет около 10 минут': 'La "Calibrazione Livellamento Manuale" sta per iniziare,\nrichiederà circa 10 минут.',
    ...
    'Проверка устройства...': 'Verifica устройство...',
