...
TRANSLATIONS = {
    ...
    'Текущий режим': 'Modalità attuale',
    ...
    '• Автоматическое распознавание после предварительной загрузки.': '• Riconoscimento automatico dopo il pre-caricamento.' + ' ' * 20,
    ...
    'Ошибка загрузки': 'Errore caricamento',
    'Заменить фильтр': 'Sostituisci filtro',
    'Извлеките старый фильтр и установите новый, как показано на рисунке.': 'Rimuovi il vecchio filtro e installa il nuovo come in figura.' + ' ' * 20,
    'Замена фильтра не завершена. Выйти все равно?': 'Sostituzione non completata. Uscire comunque?' + ' ' * 20,
    ...
    'Аномалия калибровки_Неверные параметры калибровки. Обратитесь в службу технической поддержки.': 'Err. calibrazione_Parametri di calibrazione non validi. Contattare il supporto tecnico.' + ' ' * 20,
    ...
    'Системная аномалия_Не удалось получить список файлов.': 'Anomalia sistema_Impossibile ottenere la lista dei file.' + ' ' * 20,
    ...
    'Системная аномалия_Не удается открыть файл нарезки.': 'Anomalia sistema_Impossibile aprire il file di slicing.' + ' ' * 20,
    'Системная аномалия_Удаление данных о выключении питания во время печати запрещено.': 'Anomalia sistema_Eliminazione dati di recupero energetico in stampa vietata.' + ' ' * 20,
